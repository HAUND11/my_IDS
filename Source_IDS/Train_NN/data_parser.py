...
class PARSER:
	...
	def headers_data_3L(main_data_2):
		...
		if (eth_data.type == 0x0800):	 										#IPv4
			return_struct_3["Destination"] = int(main_data_3.dst.hex(),16)
			return_struct_3["Source"] = int(main_data_3.src.hex(),16)
		...
		if (eth_data.type == 0x0806):											#ARP
			...
			return_struct_3["Sender_protocol_address"] = main_data_3.spa.hex() # Sender_protocol_address
			return_struct_3["Target_hardware_address"] = main_data_3.tha.hex()
			return_struct_3["Target_protocol_address"] = main_data_3.tpa.hex() # Target_protocol_address
